we need to merge the initialFile logics with the rest file logics, don't make it special. this should be done by making clear the relationship between detectedInfo and shard.data. put it simply:
